...
RSpec.describe '/api/v1/widget/conversations/toggle_typing', type: :request do
  ...
  describe 'POST /api/v1/widget/conversations/set_custom_attributes' do
    let(:params) { { website_token: web_widget.website_token, custom_attributes: { 'product_name': 'Upperchat' } } }
    ...
    context 'with correct website token' do
      it 'sets the values when provided' do
        ...
        expect(conversation.custom_attributes).to include('product_name' => 'Upperchat')
      end
    end
  end
  ...
  describe 'POST /api/v1/widget/conversations/destroy_custom_attributes' do
    ...
    context 'with correct website token' do
      it 'sets the values when provided' do
        ...
        conversation.custom_attributes = { 'product_name': 'Upperchat' }
        conversation.save!
        expect(conversation.custom_attributes).to include('product_name' => 'Upperchat')
        ...
        expect(conversation.custom_attributes).not_to include('product_name' => 'Upperchat')
      end
    end
  end
end
